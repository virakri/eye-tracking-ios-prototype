...
fileURLs.append(Bundle.main.url(forResource: "001", withExtension: "csv")!)
fileURLs.append(Bundle.main.url(forResource: "002", withExtension: "csv")!)
fileURLs.append(Bundle.main.url(forResource: "003", withExtension: "csv")!)
fileURLs.append(Bundle.main.url(forResource: "004", withExtension: "csv")!)
fileURLs.append(Bundle.main.url(forResource: "005", withExtension: "csv")!)
fileURLs.append(Bundle.main.url(forResource: "006", withExtension: "csv")!)
fileURLs.append(Bundle.main.url(forResource: "007", withExtension: "csv")!)
fileURLs.append(Bundle.main.url(forResource: "008", withExtension: "csv")!)
//fileURLs.append(Bundle.main.url(forResource: "009", withExtension: "csv")!)
fileURLs.append(Bundle.main.url(forResource: "010", withExtension: "csv")!)
...
let testFileURL = (Bundle.main.url(forResource: "001", withExtension: "csv")!)
var testTable = try MLDataTable(contentsOf: testFileURL)

let evaluationX = regressorX.evaluation(on: testData.1)
let evaluationY = regressorY.evaluation(on: testData.1)
